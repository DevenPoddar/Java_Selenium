...
public class Account_System {
	...
	public static void main(String[] args) {
		...
		Account acc1 = new Saving_Account("Deven Poddar",200212,25000.00,"Rishra","16/02/2002");
		Account acc2 = new Current_Account("Deven Poddar",200212,30000.00,"Rishra","16/02/2002");
