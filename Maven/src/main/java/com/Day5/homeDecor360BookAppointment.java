...
public class homeDecor360BookAppointment {
	public static void main(String args[]) throws InterruptedException {
		...
		System.out.print("Enter the brand to select: ");
		...
		List<WebElement> styleOptions = dropdown1.getOptions();
		System.out.println("Available Styles: ");
		for (WebElement option : styleOptions) {
			System.out.println(option.getText());
		}

		System.out.println("Enter the style to select: ");
		String styleChoice = in.nextLine();
		dropdown1.selectByValue(styleChoice);
