	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 1:
				...
				for (Entry<String, TreeMap<String, Appointment>> deptEntry : appointments.entrySet()) {
					System.out.println("Department: " + deptEntry.getKey());
					for (Entry<String, Appointment> empEntry : deptEntry.getValue().entrySet()) {
			...
			case 4:
				if (!appointments.isEmpty()) {
					System.out.println("First Appointment: \n Booking time : " + appointments.firstEntry().getKey()
							+ " : " + appointments.firstEntry().getValue());
					System.out.println("Last Appointment:\n Booking time :  " + appointments.lastEntry().getKey()
							+ " : " + appointments.lastEntry().getValue());
